...
/*
* Given a simple calculator implement edge case
* and input verification that outputs error
* messages and gracefully shuts down.
 */

// operator is the map of legal operators and their functions
